...
public class ListCategoriesUseCaseTest {
    ...
    public void givenAValidQuery_whenCallListCategories_thenShouldReturnCategories() {
        final var categories = List.of(
                Category.newCategory("Adventure", "Exciting and risky experiences filled with challenges.", true),
                Category.newCategory("Science Fiction", "Stories based on advanced science, technology, and futuristic concepts.", true)
        );
